...
public class SpaceshipTests {
    ...
    private static final String ASTRUNAUT_NAME = "PESHO";
    private static double oxygen = 50.0;
    private static final Astronaut ASTRONAUT = new Astronaut(ASTRUNAUT_NAME, oxygen);
    private Spaceship spaceship;
    private static final int CAPACITY = 2;
    private static final String SPACE_SHIP_NAME = "NAME";
    private static final String TEST_AUSTRONAUT_NAME = "IVAN";
    private static final double TEST_OXYGEN = 60;
    private static final Astronaut TEST_ASTRONAUT = new Astronaut(TEST_AUSTRONAUT_NAME, TEST_OXYGEN);
    ...
    public void shouldThrowCorrectMessageAlreadyAdded () {
        ...
        Assert.assertEquals(String.format(ASTRONAUT_EXIST, ASTRUNAUT_NAME), actual);
    }

    @Test
    public void shouldRemoveAstrounat() {
        boolean actual = this.spaceship.remove(ASTRUNAUT_NAME);
